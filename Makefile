...
curiosity-perf.o: curiosity-perf.c environnement.h programme.h \
	interprete.h robot.h terrain.h generation_terrains.h type_pile.h \
	observateur.h
...
# Supprime aussi les rapports d'erreurs
cleanerr:
	rm -f $(PROGRAMMES) *.err

# Supprime aussi les rapports de perfomance
cleanperf:
	rm -f $(PROGRAMMES) *.perf